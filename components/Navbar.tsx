...
export const Navbar = () => {
	...
	return (
		<nav className="absolute top-0 left-0 z-20  w-full duration-1000 ease-in ">
			<div className="item-center m-auto flex max-w-[1240px] items-center justify-between p-4 ">
				...
				{/* right side */}
				<button className="hidden rounded-lg border-2 bg-black py-1  px-3 font-bold text-white duration-500 hover:bg-white hover:text-black sm:block">
					Sign Up
				</button>
